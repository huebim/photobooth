...
return [
    'general' => [
        ...
        'picture_thumb_banner_text' => [
            'view' => 'advanced',
            'type' => 'input',
            'placeholder' => $defaultConfig['picture']['thumb_banner_text'],
            'name' => 'picture[thumb_banner_text]',
            'value' => htmlentities($config['picture']['thumb_banner_text'] ?? ''),
        ],
        'reload_key' => [
            'view' => 'expert',
            'type' => 'input',
        ...
        'run_cleanup' => [
            'view' => 'basic',
            'type' => 'button',
            'placeholder' => 'run_cleanup',
            'name' => 'RUNCLEANUP',
            'value' => 'runcleanup-btn',
        ],
        'auto_delete_enabled' => [
            'view' => 'basic',
            'type' => 'checkbox',
            'name' => 'auto_delete[enabled]',
            'value' => $config['auto_delete']['enabled'] ?? false,
        ],
        'auto_delete_ttl_minutes' => [
            'view' => 'basic',
            'type' => 'number',
            'placeholder' => $defaultConfig['auto_delete']['ttl_minutes'] ?? 45,
            'name' => 'auto_delete[ttl_minutes]',
            'value' => $config['auto_delete']['ttl_minutes'] ?? 45,
        ],
        'auto_delete_excluded_files' => [
            'view' => 'basic',
            'type' => 'list',
            'placeholder' => 'Enter filename to exclude (e.g. 1.jpg)',
            'name' => 'auto_delete[excluded_files]',
            'value' => $config['auto_delete']['excluded_files'] ?? [],
        ],
        'files_upload' => [
            'view' => 'basic',
            'type' => 'button',
    ...
    'pictures' => [
        ...
        'rembg_enabled' => [
            ...
            'type' => 'checkbox',
            'name' => 'rembg[enabled]',
            'placeholder' => 'manual:rembg:enabled',
        ...
        'rembg_alpha_matting' => [
            ...
            'help' => 'manual:rembg:alpha_matting',
        ...
        'rembg_background' => [
            ...
            'paths' => [
                ...
                PathUtility::getAbsolutePath('private/images'),
            ],
            'help' => 'manual:rembg:background'
        ],
        'rembg_background_mode' => [
            'view' => 'advanced',
            'type' => 'select',
        ...
        'rembg_post_processing' => [
            ...
            'placeholder' => 'manual:rembg:post_processing',
